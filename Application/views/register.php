            ...
            <form action="<?php echo base_url();?>/insert" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" placeholder="Full Name" name="fullname"id="fullname" value="<?php echo set_value('fullname');?>" /> 
                        <?php echo form_error('fullname', '<div class="required">', '</div>'); ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" placeholder="Address" name="address"id="address" value="<?php echo set_value('address');?>" /> 
                        <?php echo form_error('address', '<div class="required">', '</div>'); ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <?php echo form_error('city', '<div class="required">', '</div>'); ?>
                     </div>                 
                </div>
                ...
                <div class="form-group">
                    <div class="input-icon">
                        ...
                        <?php echo form_error('country', '<div class="required">', '</div>'); ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username"id="username"  value="<?php echo set_value('username');?>"  />
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <div class="input-icon">
                            <i class="fa fa-check"></i>
                            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" name="rpassword" value="<?php echo set_value('rpassword');?>"/> 
                        <?php echo form_error('rpassword', '<div class="required">', '</div>'); ?>
                    </div>
                    </div>
                </div>
                <div class="form-group">
